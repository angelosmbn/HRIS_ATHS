...
<body>
    ...
    <form action="" method="POST">
        <h1>
            <span style="color: black;">Classification Values</span>  
        </h1>
        <div>
        ...
        <div id="recordInputs" style="display: none;">
            <label for="value">Enter Classification Value:</label>
            ...
            <?php
                if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submitRecord'])) {
                    ...
                    if ($result) {
                        ...
                        history($_SESSION['control_number'], "Settings", "Classification Value Added");
                ...
                $sql = "SELECT * FROM data_values WHERE data_type = 'classification'";
